...
from data_generator.config import PIT_STOP_MEAN_COUNT, PIT_STOP_STD_DEVIATION, LAP_COUNT
...
class PitStop(Model):
    ...
    def generate(cls, n=1, race_results=None):
        ...
        for race_result in race_results:
            pit_stop_laps=random.sample(range(1, LAP_COUNT + 1), race_result.total_pit_stops)
