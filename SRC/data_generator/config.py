...
# PIT STOP
PIT_STOP_MEAN_COUNT = 2 # DEFAULT 2
PIT_STOP_STD_DEVIATION = 0.6 # DEFAULT 0.6
...
SEASON_START_MONTH = '01'  # DEFAULT 01 (JANUARY)
SEASON_START_DAY = '01'  # DEFAULT 1
SEASON_END_MONTH = '12'  # DEFAULT 12 (DECEMBER)
...
QUALIFYING_FORMAT_SPRINT_RATE = 0.1
