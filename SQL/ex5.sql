...
WITH temp AS (SELECT pitstop.pitstop_id,
              ...
              FROM pitstop
                       JOIN driver ON driver.driver_id = pitstop.driver_id
                       JOIN grandprix ON grandprix.race_id = pitstop.race_id
                       JOIN driverentry ON driverentry.driver_id = driver.driver_id
                  AND driverentry.season_id = grandprix.season_id
                       JOIN constructor ON driverentry.constructor_id = constructor.constructor_id)
